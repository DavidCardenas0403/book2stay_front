    ...
    <div>
        ...
        >
            <TabView v-model:activeIndex="active">
                ...
                >
                    <div>
                        <Label for="name" class="label" :required="true"
                            >Name</Label
                        >
                        <InputText
                            type="text"
            ...
            <div class="ps-5 gap-6 grid justify-end grid-cols-1 lg:grid-cols-2">
                <div>
                    <Label for="rooms" class="label" :required="true"
                        >Rooms</Label
                    >
                    <InputNumber
                        inputClass="w-full"
                ...
                <div>
                    <Label for="size" class="label" :required="true"
                        >Size</Label
                    >
                    <InputNumber
                        inputClass="w-full"
                ...
                <div>
                    <Label for="price" class="label" :required="true"
                        >Price
                        <span class="text-gray-400">per night</span></Label
                    >
                    <InputNumber
                        v-model="data.price"
                        inputId="price"
                ...
                <div>
                    <Label for="capacity" class="label" :required="true"
                        >Capacity</Label
                    >
                    <InputNumber
                ...
                <div>
                    <Label for="beds" class="label" :required="true"
                        >Beds</Label
                    >
                    <InputNumber
                        v-model="data.beds"
                ...
                <div>
                    <Label for="parking" class="label" :required="true"
                        >Parking</Label
                    >
                    <InputSwitch id="parking" v-model="data.parking" />
                </div>
                <div>
                    <Label for="wifi" class="label" :required="true"
                        >Wi-Fi</Label
                    >
                ...
                <div>
                    <Label for="terrace" class="label" :required="true"
                        >Terrace</Label
                    >
