<template>
    <h1 class="text-center">{{ propertyId ? "Edit" : "Add"
        }}
        property</h1>
    ...
    <form v-else
        ...
        <TabView v-model:activeIndex="active">
            <TabPanel v-for="lang in languages"
                :header="lang.name">
                <div>
                ...
                <div class="mt-4">
                    ...
                    <Editor itemid="description"
                        id="description" class="break-all"
        ...
        <div
            class="ps-5 gap-6 grid justify-end grid-cols-1 lg:grid-cols-2">
            <div>
                <Label for="rooms" class="label"
                    :required="true">Rooms</Label>
                <InputNumber inputClass="w-full"
                    v-model="data.rooms" inputId="rooms"
            ...
            <div>
                <Label for="size" class="label"
                    :required="true">Size</Label>
                <InputNumber inputClass="w-full"
                    v-model="data.size" inputId="size"
                    showButtons buttonLayout="horizontal"
                    :step="5" :min="1" suffix=" m&sup2;">
                    <template #incrementbuttonicon>
                        <span class="pi pi-plus" />
                    </template>
                    <template #decrementbuttonicon>
            ...
            <div>
                <Label for="price" class="label"
                    :required="true">Price <span
                        class="text-gray-400">per
                        night</span></Label>
                <InputNumber v-model="data.price"
                    inputId="price" showButtons
                    buttonLayout="horizontal" :step="5"
                    :min="1" mode="currency" currency="EUR">
                    <template #incrementbuttonicon>
                        <span class="pi pi-plus" />
                    </template>
                    <template #decrementbuttonicon>
            ...
            <div>
                <Label for="capacity" class="label"
                    :required="true">Capacity</Label>
                <InputNumber v-model="data.capacity"
                    inputId="capacity" showButtons
            ...
            <div>
                <Label for="beds" class="label"
                    :required="true">Beds</Label>
                <InputNumber v-model="data.beds"
                    inputId="beds" showButtons
                    buttonLayout="horizontal" :step="1"
                    :min="1">
                    <template #incrementbuttonicon>
                        <span class="pi pi-plus" />
            ...
            <div>
                <Label for="bathrooms" class="label"
                    :required="true">Bathrooms</Label>
                <InputNumber v-model="data.bathrooms"
                    inputId="bathrooms" showButtons
                    buttonLayout="horizontal" :step="1"
                    :min="1">
                    <template #incrementbuttonicon>
                        <span class="pi pi-plus" />
            ...
            <div>
                <Label for="parking" class="label"
                    :required="true">Parking</Label>
                <InputSwitch id="parking"
                    v-model="data.parking" />
            </div>
            <div>
                <Label for="wifi" class="label"
                    :required="true">Wi-Fi</Label>
                <InputSwitch id="wifi"
                    v-model="data.wifi" />
            </div>
            <div>
                <Label for="swimming_pool" class="label"
                    :required="true">Swimming Pool</Label>
                <InputSwitch id="swimming_pool"
                    v-model="data.swimming_pool" />
            </div>
            <div>
                <Label for="terrace" class="label"
                    :required="true">Terrace</Label>
                <InputSwitch id="terrace"
                    v-model="data.terrace" />
            </div>
        </div>
        <Button class="w-full mt-6" type="submit" :label="propertyId ? 'Update'
        : 'Create'" @click.prevent="handleSubmit" />
    </form>
</template>
